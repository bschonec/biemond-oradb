...
define oradb::installasm (
  ...
  Optional[String] $gimr_diskgroup                                                 = undef,
  Optional[String] $disk_discovery_string                                          = undef,
  String $disk_redundancy                                                          = 'NORMAL',
  Optional[String] $gimr_disk_redundancy                                           = undef,
  Integer $disk_au_size                                                            = 1,
  Enum['true','false'] $execute_root_script                                        = 'false',
  Optional[String] $scan_type                                                      = undef,
  Optional[Enum['true','false']] $configure_gns                                    = undef,
  Optional[Enum['true','false']] $configure_gimr_data                              = undef,
  Optional[Enum['true','false']] $configure_gimr                                   = undef,
  Optional[Enum['true','false']] $auto_configure_vip                               = undef,
  Optional[Enum['true','false']] $use_ipmi                                         = undef,
  Optional[Enum['true','false']] $configure_afd                                    = undef,
  Optional[Enum['true','false']] $configure_rhps                                   = undef,
  Optional[Enum['true','false']] $ignore_down_nodes                                = undef,
  Optional[Enum['NONE','CLOUD_CONTROL']] $management_option                        = undef,
  Optional[Enum['ROOT','SUDO']] $root_script_config                                = undef,
  Optional[String] $root_script_sudo_path                                          = undef,
  Optional[String] $root_script_sudo_user                                          = undef,
  Optional[String] $disks                                                          = undef,
  Optional[String] $disks_with_failure_groups                                      = undef,
  Optional[String] $gimr_disks                                                     = undef,
  Optional[String] $gimr_disks_with_failure_groups                                 = undef,
  Boolean $remote_file                                                             = true,
  Optional[String] $cluster_name                                                   = undef,
  Optional[String] $scan_name                                                      = undef,
  Optional[Integer] $scan_port                                                     = undef,
  Optional[Integer] $oms_port                                                      = undef,
