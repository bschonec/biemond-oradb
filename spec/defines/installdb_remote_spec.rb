...
describe 'oradb::installdb', type: :define do
  describe 'CentOS remote' do
    ...
    context 'with no oradb_inst_loc_data fact' do
      describe 'oradb utils structure' do
        it do
          is_expected.to contain_db_directory_structure('oracle structure 12.1.0.1_12.1.0.1_Linux-x86-64').with({
                                                                                                                  'ensure' => 'present',
      ...
      describe 'oradb orainst' do
        it do
          is_expected.to contain_oradb__utils__dborainst('database orainst 12.1.0.1_12.1.0.1_Linux-x86-64').with({
                                                                                                                   'ora_inventory_dir' => '/u01/app/oraInventory',
                                                                                                                   'os_group' => 'oinstall',
                                                                                                                 })
        end
    ...
    describe 'oradb response file' do
      it do
        is_expected.to contain_file('/install/db_install_12.1.0.1_12.1.0.1_Linux-x86-64.rsp').that_requires('Oradb::Utils::Dborainst[database orainst 12.1.0.1_12.1.0.1_Linux-x86-64]')
      end
    end

    describe 'oradb file1' do
      it {
        is_expected.to contain_file('/install/linuxamd64_12c_database_1of2.zip').with({
    ...
    describe 'oradb extract file1' do
      it {
        is_expected.to contain_exec('extract /install/linuxamd64_12c_database_1of2.zip').with({
    ...
    describe 'oradb file2' do
      it do
        is_expected.to contain_file('/install/linuxamd64_12c_database_2of2.zip').with({
    ...
    describe 'oradb extract file2' do
      it {
        is_expected.to contain_exec('extract /install/linuxamd64_12c_database_2of2.zip').with({
    ...
    describe 'oradb install database' do
      it {
        is_expected.to contain_exec('install oracle database 12.1.0.1_Linux-x86-64').with({
    ...
    describe 'oracle home' do
      it do
        is_expected.to contain_file('/u01/app/oracle/product/12.1/db').with({
                                                                              'ensure' => 'directory',
                                                                              'owner' => 'oracle',
                                                                              'group' => 'oinstall',
    ...
    describe 'oracle bash_profile' do
      it do
        is_expected.to contain_file('/home/oracle/.bash_profile').with({
                                                                         'owner' => 'oracle',
                                                                         'group' => 'dba',
                                                                       })
      end
    ...
    describe 'exec root.sh' do
      it do
        is_expected.to contain_exec('run root.sh script 12.1.0.1_Linux-x86-64').with({
  ...
  describe 'CentOS local' do
    ...
    describe 'oradb utils structure' do
      it do
        is_expected.to contain_db_directory_structure('oracle structure 11.2.0.4_11.2.0.4_Linux-x86-64').with({
                                                                                                                'ensure' => 'present',
                                                                                                                'oracle_base_dir' => '/u01/app/oracle',
                                                                                                                'ora_inventory_dir' => '/u01/app/oraInventory',
                                                                                                                'os_user' => 'oracle',
    ...
    describe 'oradb orainst' do
      it do
        is_expected.to contain_oradb__utils__dborainst('database orainst 11.2.0.4_11.2.0.4_Linux-x86-64').with({
                                                                                                                 'ora_inventory_dir' => '/u01/app/oraInventory',
                                                                                                                 'os_group' => 'oinstall',
                                                                                                               })
      end
    ...
    describe 'oradb response file' do
      it do
        is_expected.to contain_file('/install/db_install_11.2.0.4_11.2.0.4_Linux-x86-64.rsp').that_requires('Oradb::Utils::Dborainst[database orainst 11.2.0.4_11.2.0.4_Linux-x86-64]')
      end
    end

    describe 'oradb extract file1' do
      it {
        is_expected.to contain_exec('extract /install/p13390677_112040_Linux-x86-64_1of7.zip').with({
    ...
    describe 'oradb extract file2' do
      it {
        is_expected.to contain_exec('extract /install/p13390677_112040_Linux-x86-64_2of7.zip').with({
    ...
    describe 'oradb install database' do
      it {
        is_expected.to contain_exec('install oracle database 11.2.0.4_Linux-x86-64').with({
    ...
    describe 'oracle home' do
      it do
        is_expected.to contain_file('/u01/app/oracle/product/11.2/db').with({
                                                                              'ensure' => 'directory',
                                                                              'owner' => 'oracle',
                                                                              'group' => 'oinstall',
    ...
    describe 'exec root.sh' do
      it do
        is_expected.to contain_exec('run root.sh script 11.2.0.4_Linux-x86-64').with({
  ...
  describe 'CentOS unpacked' do
    ...
    let(:facts) do
      { os: { name: 'OracleLinux', family: 'RedHat' },
        kernel: 'Linux' }
    end

    describe 'oradb utils structure' do
      it do
        is_expected.to contain_db_directory_structure('oracle structure 11.2.0.3_11.2.0.3_Linux-x86-64').with({
                                                                                                                'ensure' => 'present',
                                                                                                                'oracle_base_dir' => '/u01/app/oracle',
                                                                                                                'ora_inventory_dir' => '/u01/app/oraInventory',
                                                                                                                'os_user' => 'oracle',
    ...
    describe 'oradb orainst' do
      it do
        is_expected.to contain_oradb__utils__dborainst('database orainst 11.2.0.3_11.2.0.3_Linux-x86-64').with({
                                                                                                                 'ora_inventory_dir' => '/u01/app/oraInventory',
                                                                                                                 'os_group' => 'oinstall',
                                                                                                               })
      end
    ...
    describe 'oradb response file' do
      it do
        is_expected.to contain_file('/mnt/db_install_11.2.0.3_11.2.0.3_Linux-x86-64.rsp').that_requires('Oradb::Utils::Dborainst[database orainst 11.2.0.3_11.2.0.3_Linux-x86-64]')
      end
    end

    describe 'oradb install database' do
      it {
        is_expected.to contain_exec('install oracle database 11.2.0.3_Linux-x86-64').with({
    ...
    describe 'exec root.sh' do
      it do
        is_expected.to contain_exec('run root.sh script 11.2.0.3_Linux-x86-64').with({
                                                                                       'command' => '/u01/app/oracle/product/11.2/db/root.sh',
                                                                                       'group' => 'root',
                                                                                     }).that_requires('Exec[install oracle database 11.2.0.3_Linux-x86-64]')
      end
